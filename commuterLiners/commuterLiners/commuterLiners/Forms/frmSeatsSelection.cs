...
namespace commuterLiners.Forms
{
    public partial class frmSeatsSelection : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            int regularCount = string.IsNullOrEmpty(personCountRegular) ? 0 : int.Parse(personCountRegular);
            int discountCount = string.IsNullOrEmpty(personCountDiscount) ? 0 : int.Parse(personCountDiscount);
